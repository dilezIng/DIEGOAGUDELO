<%@ Page Title="Resumen Centros de Costos" Language="vb" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="true" CodeFile="ResumenCenCos.aspx.vb" Inherits="Facturacion_ResumenFacturacion" %>
    ...
    <table style="width: 100%; font-size: 10pt; font-family: Tahoma;">
        ...
        <tr>
            ...
            <td style="width: 25%">
                ...
                <asp:CheckBox ID="CheckFechaFiltroAnul" runat="server" 
                    Text="Filtrar por fecha Anulación" Enabled="False" />
            </td>
            <td style="width: 25%">
                Tipo Ingreso
        ...
        <tr>
            <td style="border: 1px solid #808080; width: 40%; font-size: 10pt; font-weight: normal; text-align: right;" 
                ...
                Buscar por:
                <asp:DropDownList ID="ListTipoBusqueda" runat="server" Enabled="False">
                    <asp:ListItem Value="0">Factura</asp:ListItem>
                    <asp:ListItem Value="1">Paciente</asp:ListItem>
                </asp:DropDownList>
                &nbsp; No.&nbsp;
                <asp:TextBox ID="TextBuscar" runat="server" Width="120px" Enabled="False"></asp:TextBox>
                &nbsp;
                <asp:Button ID="ButtonBuscar" runat="server" Text="Buscar" Enabled="False" />
            </td>
            <td colspan="3" 
        ...
        <tr>
            <td colspan="5">
                <asp:DataList ID="ListaTipPlanesBeneficio" runat="server" DataKeyField="IdCenCos" 
                    DataSourceID="DataListTipPlanesBeneficio" Width="100%">
                    <AlternatingItemStyle BackColor="#F0F0F0" />
                    <ItemTemplate>
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 49%; left: 100px;">
                                    <asp:Label ID="LabelNomCenCos" runat="server" style="font-weight: 700" 
                                        Text='<%# Eval("CCNOMBRE") %>'></asp:Label>
                                    &nbsp;(<asp:Label ID="CodCenCosLabel" runat="server" style="font-weight: 700" 
                                        Text='<%# Eval("CCCODIGO") %>' />
                                    )</td>
                                <td style="width: 1%; text-align: right;">
                                    &nbsp;</td>
                                <td style="width: 15%; text-align: right;">
                                    $<asp:Label ID="TotalCenCosLabel" runat="server" 
                                        style="font-weight: 700; " Text='<%# Eval("Total", "{0:N0}") %>'></asp:Label>
                                </td>
                                <td style="width: 15%; text-align: right;">
                                ...
                                <td style="width: 20%; text-align: right;">
                                    <asp:LinkButton ID="LinkVerPlanBeneficio" runat="server" 
                                        CommandName="VerPlanes" Visible="False" >Ver Planes de Beneficio</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                ...
                <asp:SqlDataSource ID="DataListTipPlanesBeneficio" runat="server" 
                    ...
                    SelectCommand="SELECT CTNCENCOS.CCCODIGO, CTNCENCOS.CCNOMBRE, SUM(SLNSERPRO.SERVALPRO) AS Total, CTNCENCOS.OID AS IdCenCos FROM SLNFACTUR INNER JOIN ADNINGRESO ON SLNFACTUR.ADNINGRESO = ADNINGRESO.OID INNER JOIN SLNSERPRO ON ADNINGRESO.OID = SLNSERPRO.ADNINGRES1 INNER JOIN CTNCENCOS ON SLNSERPRO.CTCENCOS1 = CTNCENCOS.OID WHERE (SLNFACTUR.SFADOCANU = 0) AND (SLNSERPRO.SERFECSER BETWEEN @FechaInicio AND @FechaFin) GROUP BY CTNCENCOS.CCCODIGO, CTNCENCOS.CCNOMBRE, CTNCENCOS.OID ORDER BY CTNCENCOS.CCNOMBRE">
                    <SelectParameters>
