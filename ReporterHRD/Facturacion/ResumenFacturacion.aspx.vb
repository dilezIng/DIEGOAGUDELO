...
Partial Class Facturacion_ResumenFacturacion
    ...
    Function ValTotalRango()
        ...
        If objDS.Tables(0).Rows.Count > 0 Then
            ...
            LabelTotRango0.Text = "TOTAL PACIENTE 5 $" & FormatNumber(objDS.Tables(0).Rows(0).Item(1).ToString, 0, , , TriState.True) & " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; TOTAL ENTIDADES $" & FormatNumber(LabelTotRango.Text, 0, , , TriState.True)
