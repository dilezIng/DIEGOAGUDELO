   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server" 
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <tr style="font-weight: bold; font-size: 20pt; color: #FFFFFF; background-image: url('../Images/Fondo01.jpg');">
            <td colspan="4" 
                >Solicitud Procedimientos Quirurgicos CONSULTA EXTERNA</td>
                ...
                <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1"  DataKeyNames="Sol_QX"
                    ...
                    <Columns>
                        ...
                        <asp:CommandField SelectText="Edit" ShowSelectButton="True" />
                             <asp:BoundField DataField="Sol_QX" HeaderText="Sol_QX" SortExpression="Sol_QX" />
    ...
    <asp:Panel ID="Panel2" runat="server"  Height="112px" Width="1082px">
                ...
                <td class="auto-style11" colspan="2">
                    <asp:DropDownList ID="ListEstado" runat="server">
                        ...
                        <asp:ListItem Value="5">Ambulatorio</asp:ListItem>
						 <asp:ListItem Value="6">Operado</asp:ListItem>
						  <asp:ListItem Value="7">Derecho de Peticion</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
        ...
        <asp:Panel ID="Panel3" runat="server">
            ...
            <asp:SqlDataSource ID="SqlDataHist" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Date AS Fecha, Id_Sol_QX AS Solicitud, Realiza AS Usuario, Nota AS Observación, CASE WHEN Estado = 3 THEN 'Autorizado' WHEN Estado = 1 THEN 'En Tramite' WHEN Estado = 2 THEN 'No Autorizado' WHEN Estado = 0 THEN 'No Iniciado' WHEN Estado = 4 THEN 'No Aplica' WHEN Estado = 5 THEN 'Ambulatorio' WHEN Estado = 6 THEN 'Operado' WHEN Estado = 7 THEN 'Derecho de Peticiòn' END AS Estado FROM Cryc_SolQX_AUD WHERE (Id_Sol_QX = @Ingreso) ORDER BY ID">
                <SelectParameters>
