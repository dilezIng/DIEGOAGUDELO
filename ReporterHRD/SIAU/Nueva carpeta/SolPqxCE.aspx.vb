...
Partial Class PaginaBase
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ' Response.AddHeader("REFRESH", "1;SolPqx.aspx")
        TextFechaIni.text = Inicio
        LabelFechaFin.Text = Final
        LabelInfo.Text = ""
