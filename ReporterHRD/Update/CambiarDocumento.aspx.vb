...
Partial Class Update_DescoEpicri
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            For i = 0 To 15
                ListTpoDoc.Items.Add(i.ToString)
                ListTpoDoc.Items.Item(i).Value = i.ToString
                ListTpoDoc.Items.Item(i).Text = vbFunciones.TipoDocGen(i.ToString).ToString
            Next
        End If
    ...
    Private Function DatPaciente(ByVal NumDocumento As String)
        ...
        StrConsulta = StrConsulta + "WHERE (GENPACIEN.PACNUMDOC = N'" & NumDocumento & "')" '+ TxtNumEpicri.Text 'Por Ingreso
        ...
        If objDS.Tables(0).Rows.Count > 0 Then
           ...
           Try
                ListTpoDoc.SelectedIndex = CInt(objDS.Tables(0).Rows(0).Item(2))
...
carpeta="CN"+TextNueNumDoc.Text
        ...
        If PacienteExiste(TextNueNumDoc.Text) = False Then
            If ListTpoDoc.SelectedValue > 0 Then
                ...
                If TextNueNumDoc.Text.Trim.ToUpper.Length > 0 And TextNuePrimNombre.Text.Trim.ToUpper.Length > 0 And TextNuePrimApel.Text.Trim.ToUpper.Length > 0 Then
                    ...
                    DataUpdate.UpdateCommand = "UPDATE GENPACIEN SET PACNUMDOC = N'" & TextNueNumDoc.Text.Trim & "', PACTIPDOC = " & ListTpoDoc.SelectedValue.ToString & ", GPANUMCAR = N'" & carpeta & "', PACPRINOM = N'" & TextNuePrimNombre.Text.Trim.ToUpper & "', PACSEGNOM = N'" & TextNueSegNombre.Text.Trim.ToUpper & "', PACPRIAPE = N'" & TextNuePrimApel.Text.Trim.ToUpper & "', PACSEGAPE = N'" & TextNueSegApel.Text.Trim.ToUpper & "', GPANOMPAD = N'" & TextNueNomPadre.Text.Trim.ToUpper & "', GPANOMMAD = N'" & TextNueNomMadre.Text.Trim.ToUpper & "'  WHERE OID = " & LabelIdPaciente.Text
                    DataUpdate.Update()

                    DataUpdate.UpdateCommand = "UPDATE  GENTERCER SET TERNUMDOC = N'" & TextNueNumDoc.Text.Trim.ToUpper & "', TERTIPDOC = " & ListTpoDoc.SelectedValue.ToString & ", TERPRINOM = N'" & TextNuePrimNombre.Text.Trim.ToUpper & "', TERSEGNOM = N'" & TextNueSegNombre.Text.Trim.ToUpper & "', TERPRIAPE = N'" & TextNuePrimApel.Text.Trim.ToUpper & "', TERSEGAPE = N'" & TextNueSegApel.Text.Trim.ToUpper & "' WHERE OID = " & LabelIdTercero.Text
                    DataUpdate.Update()

                    TextObservacion.Text = Page.User.Identity.Name.ToString+" "+TextObservacion.Text.Trim
                ...
                'End If
            Else
                LabelInfo.Text = "El Tipo de documento seleccionado debe ser diferente a Ninguno"
                LabelInfo.Visible = True
            End If
