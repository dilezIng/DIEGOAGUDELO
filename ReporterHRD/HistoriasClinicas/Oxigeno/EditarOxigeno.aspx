<%@ Page Title="Administración de Oxigeno" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.master" CodeFile="EditarOxigeno.aspx.vb" Inherits="EditOxigeno" %>
...
<asp:Label ID="LbIngreso" runat="server" CssClass="auto-style12"></asp:Label>
        ...
        <asp:SqlDataSource ID="Dat" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" SelectCommand="SELECT Solicitud, Folio, Fecha_Folio, Codigo, Suministro, Observacion FROM O2_Sum_Paciente WHERE (Ingreso = @Ingreso)  order by Folio">
            <SelectParameters>
