...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label runat="server" Text="Oxigeno Registrado" ID="Label1"></asp:Label>
                ...
                &nbsp;
                    <asp:Label ID="Lbsalario" runat="server" CssClass="auto-style46" Enabled="true"></asp:Label>
    ...
    <tr>
        <td class="auto-style1" valign="middle">
            <asp:SqlDataSource ID="SqlOxigeno" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" SelectCommand="SELECT O2_Sum_Paciente.Solicitud, O2_Forma_Sum.Nombre AS 'Forma de Administraciòn', O2_Sum_Paciente.Fecha_Ini + ' ' + O2_Sum_Paciente.Hora_Ini AS Inicio, O2_Sum_Paciente.Fecha_Fin + ' ' + O2_Sum_Paciente.Hora_Fin AS Fin, CAST(CAST(O2_Sum_Paciente.Minutos AS DECIMAL(10 , 1)) / CAST(60 AS DECIMAL(10 , 1)) AS DECIMAL(10 , 1)) AS Horas, O2_Sum_Paciente.Usuario AS Suministra FROM O2_Sum_Paciente INNER JOIN O2_Forma_Sum ON O2_Sum_Paciente.Sum_Id = O2_Forma_Sum.Id WHERE (O2_Sum_Paciente.Ingreso = @Ingreso) ORDER BY MONTH(  CONVERT (datetime,(O2_Sum_Paciente.Fecha_Ini + ' ' + O2_Sum_Paciente.Hora_Ini) , 103)) ">
                <SelectParameters>
