...
<style type="text/css">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <tr style="font-weight: bold; font-size: 20pt; color: #FFFFFF; background-image: url('../Images/Fondo01.jpg');">
            <td bgcolor="#7EC5FD"  class="auto-style1" colspan="6">Estancia de un paciente en la sala de observación fast track y salas ERA y EDA<asp:Label ID="LabelFolio" runat="server" ></asp:Label></td>
