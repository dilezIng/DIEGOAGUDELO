...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%; font-family: tahoma;" >
        ...
        <tr >
            <td style="width: 25%" >
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" Enabled="true" 
                    RepeatDirection="Horizontal">
                    <asp:ListItem Selected="True" Value="1">Por Indicador</asp:ListItem>
                    <asp:ListItem Selected="True" Value="0">Por Usuario</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            <td style="width: 25%" >
                &nbsp;</td>
