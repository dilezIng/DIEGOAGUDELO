...
Partial Class Indicadores_Proyecto_Admins_AsocIndiUsers
    ...
    Protected Sub GridIndicadores_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridIndicadores.SelectedIndexChanged
        ...
        FormIndicadores.Visible = True
        GridIndicadores.Visible = False
        FormIndicadores.DataBind()



    End Sub

    Protected Sub FormIndicadores_ItemCommand(sender As Object, e As System.Web.UI.WebControls.FormViewCommandEventArgs) Handles FormIndicadores.ItemCommand

        FormIndicadores.Visible = False
        GridIndicadores.Visible = True


    End Sub

    Protected Sub FormIndicadores_ItemUpdated(sender As Object, e As System.Web.UI.WebControls.FormViewUpdatedEventArgs) Handles FormIndicadores.ItemUpdated
