            ...
            <tr>
                <td class="auto-style40" rowspan="4" align="center">
                    ...
                    <asp:Chart ID="Chart1" runat="server" DataSourceID="Grafica" Width="839px" EnableViewState="True">
                        <Series>
                   <asp:Series ChartArea="ChartArea1"  Name="2022" XValueMember="Mes" YValueMembers="2022" IsValueShownAsLabel="true" CustomProperties="DrawingStyle=LightToDark, PointWidth=0.5" Legend="Legend1" MarkerSize="1" XValueType="Double" YValueType="Double">
                                <EmptyPointStyle MarkerSize="2" />
                            </asp:Series>
                  <asp:Series ChartArea="ChartArea1" ChartType="FastLine" Name="2021" YValueMembers="2021"  IsValueShownAsLabel="true" Legend="Legend1" BorderWidth="3" Color="Red" >
                            </asp:Series>
                       <asp:Series ChartArea="ChartArea1" ChartType="FastLine" Name="2020" YValueMembers="2020"  IsValueShownAsLabel="true" Legend="Legend1" BorderWidth="3" Color="#00ff00" >
                            </asp:Series>
