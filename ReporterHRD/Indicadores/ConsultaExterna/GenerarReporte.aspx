<%@ Page Title="Resumen Consulta Externa" Language="VB" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="false" CodeFile="GenerarReporte.aspx.vb" Inherits="Indicadores_Triage_GenerarReporte" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
            <td colspan="4" style="font-weight: bold; font-size: 20pt; color: #FFFFFF; background-image: url('../../Images/Fondo01.jpg');">
                Resumen Consulta Externa (Actividades)</td>
        </tr>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <asp:Panel ID="Panel1" runat="server" Font-Size="8pt" 
                    GroupingText="Seleccione las Actividades" Height="100px" 
                    ScrollBars="Vertical" Width="100%">
                    <asp:CheckBoxList ID="ListEspecialidades" runat="server" 
                        DataSourceID="DataListEspecialidades" DataTextField="CMANOMBRE" 
                        DataValueField="OID">
                    </asp:CheckBoxList>
                    <asp:SqlDataSource ID="DataListEspecialidades" runat="server" 
                        ...
                        SelectCommand="SELECT DISTINCT CMNTIPACT.OID, CMNTIPACT.CMANOMBRE FROM CMNCITMED INNER JOIN GENPACIEN ON CMNCITMED.GENPACIEN = GENPACIEN.OID INNER JOIN CMNTIPACT ON CMNCITMED.CMNTIPACT = CMNTIPACT.OID WHERE (GENPACIEN.DGNMUNICIPIO = COALESCE (NULLIF (@IdMunicpio, 0), GENPACIEN.DGNMUNICIPIO)) ORDER BY CMNTIPACT.CMANOMBRE">
                        <SelectParameters>
...
<asp:ListItem Value="5">Inatención</asp:ListItem>
        ...
        <tr>
            ...
            <td style="width: 25%">
                ...
                <br />
                <asp:Button ID="Button3" runat="server" Text="Generar 266" Enabled="False" />
				   <asp:Button ID="BtnExportar" runat="server" Text="Exportar_xls" />
