...
<style type="text/css">
 ...
 Fecha Final:<asp:TextBox ID="TextFechaFin" runat="server" Width="100px"></asp:TextBox>
            ...
            <td  style=" border: 1px solid #CCCCCC; background-color: #F0F0F0; style="width: 30%; text-align: right;" >
                ...
                <asp:SqlDataSource ID="SqlDataGrupos" runat="server" ConnectionString="<%$ ConnectionStrings:DGEMPRES02ConnectionString %>" SelectCommand="SELECT N'( ' +[HGRCODIGO] +' ) '+[HGRNOMBRE] as HGRCODIGO, [OID] FROM [HPNGRUPOS] WHERE ([OID] &gt;= @OID)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="8" Name="OID" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
                &nbsp;</td>
