<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.master" Codefile="Lider3.aspx.vb" Inherits="Lider3" %>
...
<td class="style1" colspan="6">
    ...
    <tr>
        <td class="style1" colspan="6">
            ...
            <asp:SqlDataSource ID="DataListeventp0" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" SelectCommand="SELECT DISTINCT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS TemaEquipo, Sis_HV_Novedad.Fech_Sol, Sis_HV_Novedad.Nota AS Novedad, CASE WHEN Sis_HV_Novedad.Id_Job = 'ASI001' THEN 'Johana Gutierrez' WHEN Sis_HV_Novedad.Id_Job = 'ASI002' THEN 'Sebastian Mora' WHEN Sis_HV_Novedad.Id_Job = 'SUA001' THEN 'Alirio Rodríguez' WHEN Sis_HV_Novedad.Id_Job = 'SUA007' THEN 'Fabian Goyeneche' WHEN Sis_HV_Novedad.Id_Job = 'SUA009' THEN 'Diego Agudelo'  WHEN Sis_HV_Novedad.Id_Job = 'SUA011' THEN 'Emerson González' ELSE 'Por asignar' END AS Realizo, Sis_HV_Historial.Actividad AS Trabajo_Realizado, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) / 60 / 24 AS Días, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) / 60 % 24 AS Horas, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) % 60 AS Min, Sis_HV_Novedad.Estado, Sis_HV_TiposMantenimiento.Tipo_Man AS Tipo_Soporte FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento INNER JOIN Sis_HV_Dependencias ON Sis_HV_Historial.Area = Sis_HV_Dependencias.NombreDependecia INNER JOIN Sis_HV_TiposMantenimiento ON Sis_HV_Historial.Tipo_Man = Sis_HV_TiposMantenimiento.Id WHERE (Sis_HV_Novedad.Estado = 2) AND (Sis_HV_Dependencias.Lider = @user0) OR (Sis_HV_Novedad.Estado = 2) AND (Sis_HV_Dependencias.Colaborador = @user0) ORDER BY Sis_HV_Novedad.Fech_Sol">
                <SelectParameters>
