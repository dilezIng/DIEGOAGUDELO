...
Partial Class Mantenimiento_Solicitudes
    ...
    Protected Sub pendiente0_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles pendiente0.SelectedIndexChanged
        ...
        timedate.Open()
        SQL = "Select Id_Evento,Id_Job,Sis_HV_Novedad.Id_Equipo From Sis_HV_Novedad WHERE (Id_Evento =N'" & Even & "')"
        Com = New SqlCommand(SQL, timedate)
        Rs = Com.ExecuteReader()
        Rs.Read()
        Codigo1.Text = Rs(0)
        solcit = Rs(1)
TextBox2.Text= TextBox2.Text+" _  "+Rs(2)
        Rs.Close()
        timedate.Close()
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            If Estad = 1 Then
                ...
                smtp2.Credentials = New System.Net.NetworkCredential("noreplypach@gmail.com", "hrdpach2021")
    ...
    Protected Sub ImageButton1_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton1.Click
        ...
        Rsa2.Close()
        timedatea2.Close()
        DataEncuesta.InsertCommand = "INSERT INTO Encuesta(Fecha, Resultado,Tipo_Man, Evento ) VALUES (GETDATE(),'1', '" & num & "'  ,'" & Even & "' ) "
        DataEncuesta.Insert()
        histor.Visible = False
        Encuesta.Visible = False
        Panel_Asignar.Visible = False
    ...
    Protected Sub ImageButton2_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton2.Click
        ...
        DataEncuesta.InsertCommand = "INSERT INTO Encuesta(Fecha, Resultado,Tipo_Man, Evento ) VALUES (GETDATE(),'2', '" & num & "'  ,'" & Even & "') "
        DataEncuesta.Insert()
        Encuesta.Visible = False
        Panel_Asignar.Visible = False
        Panel_Asignar2.Visible = False
    ...
    Protected Sub ImageButton3_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton3.Click
        ...
        DataEncuesta.InsertCommand = "INSERT INTO Encuesta(Fecha, Resultado,Tipo_Man, Evento ) VALUES (GETDATE(),'3', '" & num & "'  ,'" & Even & "') "
        DataEncuesta.Insert()
        Encuesta.Visible = False
        Panel_Asignar.Visible = False
        Panel_Asignar2.Visible = False
    ...
    Protected Sub ImageButton4_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton4.Click
        ...
        DataEncuesta.InsertCommand = "INSERT INTO Encuesta(Fecha, Resultado,Tipo_Man, Evento ) VALUES (GETDATE(),'4', '" & num & "'  ,'" & Even & "') "
        DataEncuesta.Insert()
        Encuesta.Visible = False
        Panel_Asignar.Visible = False
        Panel_Asignar2.Visible = False
    ...
    Protected Sub ImageButton5_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton5.Click
        ...
        DataEncuesta.InsertCommand = "INSERT INTO Encuesta(Fecha, Resultado,Tipo_Man, Evento ) VALUES (GETDATE(),'5', '" & num & "'  ,'" & Even & "') "
        DataEncuesta.Insert()
        Encuesta.Visible = False
        Panel_Asignar.Visible = False
        Panel_Asignar2.Visible = False
