...
<asp:Panel ID="Panel_Asignar" runat="server">
    ...
    <table id="TabAsigna" align="center" class="auto-style13" border="1" >
        ...
        <tr>
            <td colspan="6" class="auto-style25">
                ...
                <asp:SqlDataSource ID="DataNov01" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>"></asp:SqlDataSource>
    ...
    <asp:panel ID="histor" runat="server">
        <div class="auto-style23">
            ...
            <asp:TextBox ID="TextBox2" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" Font-Bold="True" Font-Size="Large" ForeColor="Blue" ReadOnly="True" Width="600px"></asp:TextBox>
            <br />
            <br />
            <br />
        </div>
...
<td style="background-image: url('../../Images/Fondo01.jpg'); color: #FFFFFF; font-weight: bold; font-size: 20px;" 
        class="auto-style23" bgcolor="#79C2FC"> <span class="auto-style28">Oficina de Sistemas</span>
...
<td class="style1">
    ...
    <tr>
        <td class="style1">
            <asp:GridView ID="pendiente0" runat="server" AllowSorting="True" AutoGenerateColumns="False" 
			DataKeyNames="Evento" DataSourceID="DataListeventp0" EmptyDataText="No hay Eventos Pendientes." Width="1250px">
            ...
            <asp:SqlDataSource ID="DataListeventp0" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" SelectCommand=" SELECT DISTINCT CASE WHEN Sis_HV_NOVHIST.Archivo IS NOT NULL THEN 'SIN' ELSE 'OK' END AS 'Archivo', Sis_HV_Novedad.Id_Evento AS Evento,
Sis_HV_Historial.NomEquipo AS TemaEquipo,
Sis_HV_Novedad.Fech_Sol, Sis_HV_Novedad.Nota AS Novedad, 
CASE WHEN Sis_HV_Novedad.Id_Job = 'ASI001' THEN 'Johana Gutierrez' WHEN Sis_HV_Novedad.Id_Job = 'ASI002' THEN 'Sebastian Mora' WHEN Sis_HV_Novedad.Id_Job = 'SUA001' THEN 'Alirio Rodríguez' WHEN Sis_HV_Novedad.Id_Job = 'SUA007' THEN 'Fabian Goyeneche' WHEN Sis_HV_Novedad.Id_Job = 'SUA009' THEN 'Diego Agudelo'  WHEN Sis_HV_Novedad.Id_Job = 'SUA011' THEN 'Emerson González' WHEN Sis_HV_Novedad.Id_Job = 'SUA013' THEN 'Cristian Rincon'  WHEN Sis_HV_Novedad.Id_Job = 'SUA012' THEN 'German Correa'  WHEN Sis_HV_Novedad.Id_Job = 'ASI003' THEN 'Diego Ostos'   ELSE 'Por asignar' END AS Realizo, 
Sis_HV_Historial.Actividad AS Trabajo_Realizado,CASE WHEN DATEDIFF(hour , Sis_HV_Novedad.Fech_Sol , (CONVERT (datetime , Sis_HV_Historial.Aud_Time_Act , 103))) > 24 THEN DATEDIFF(DAY , Sis_HV_Novedad.Fech_Sol , CONVERT (datetime , Sis_HV_Historial.Fech_En , 103)) ELSE '0' END AS Dias, CASE WHEN DATEDIFF(hour , Sis_HV_Novedad.Fech_Sol , (CONVERT (datetime , Sis_HV_Historial.Aud_Time_Act , 103))) < 24 THEN DATEDIFF(HOUR , Sis_HV_Novedad.Fech_Sol , CONVERT (datetime , Sis_HV_Historial.Fech_En , 103)) % 24 ELSE DATEDIFF(HOUR , Sis_HV_Novedad.Fech_Sol , CONVERT (datetime , Sis_HV_Historial.Fech_En , 103)) END AS Horas, '' AS Min, Sis_HV_Novedad.Estado, Sis_HV_Novedad.Id_Sol 
FROM Sis_HV_Novedad 
INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento 
INNER JOIN Sis_HV_NOVHIST ON Sis_HV_Historial.Id_Evento =Sis_HV_NOVHIST.Evento

WHERE (Sis_HV_Novedad.Estado = 2) 
AND Sis_HV_NOVHIST.Archivo IS NOT NULL  AND (Sis_HV_Novedad.Id_Sol = @User ) ORDER BY Sis_HV_Novedad.Fech_Sol">
                <SelectParameters>
                    <asp:ControlParameter ControlID="User" Name="User" PropertyName="Text" />
                </SelectParameters>
            </asp:SqlDataSource>
...
<asp:GridView ID="pendiente" runat="server" AutoGenerateColumns="False"  DataKeyNames="Evento" DataSourceID="DataListeventp" EmptyDataText="No hay Eventos Pendientes." AllowSorting="True">
        ...
        SelectCommand="SELECT DISTINCT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Fech_Sol, Sis_HV_Novedad.Nota AS Novedad, CASE WHEN Sis_HV_Novedad.Id_Job = 'ASI001' THEN 'Johana Gutierrez' WHEN Sis_HV_Novedad.Id_Job = 'ASI002' THEN 'Sebastian Mora' WHEN Sis_HV_Novedad.Id_Job = 'SUA001' THEN 'Alirio Rodriguez' WHEN Sis_HV_Novedad.Id_Job = 'SUA007' THEN 'Fabian Goyeneche' WHEN Sis_HV_Novedad.Id_Job = 'SUA009' THEN 'Diego Agudelo' WHEN Sis_HV_Novedad.Id_Job = 'SUA013' THEN 'Cristian Rincon'  WHEN Sis_HV_Novedad.Id_Job = 'SUA011' THEN 'Emerson González' WHEN Sis_HV_Novedad.Id_Job = 'ASI003' THEN 'Diego Ostos'  ELSE 'Por asignar'  END AS Realizo, Sis_HV_Historial.Actividad AS Trabajo_Realizado, CASE WHEN DATEDIFF(hour , Sis_HV_Novedad.Fech_Sol , (CONVERT (datetime , Sis_HV_Historial.Aud_Time_Act , 103))) > 24 THEN DATEDIFF(DAY , Sis_HV_Novedad.Fech_Sol , CONVERT (datetime , Sis_HV_Historial.Fech_En , 103)) ELSE '0' END AS Dias, CASE WHEN DATEDIFF(hour , Sis_HV_Novedad.Fech_Sol , (CONVERT (datetime , Sis_HV_Historial.Aud_Time_Act , 103))) < 24 THEN DATEDIFF(HOUR , Sis_HV_Novedad.Fech_Sol , CONVERT (datetime , Sis_HV_Historial.Fech_En , 103)) % 24 ELSE DATEDIFF(HOUR , Sis_HV_Novedad.Fech_Sol , CONVERT (datetime , Sis_HV_Historial.Fech_En , 103)) END AS Horas, '' AS Min, Encuesta.Resultado AS SATISFACION FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento INNER JOIN Encuesta ON Sis_HV_Historial.Id_Evento = Encuesta.Evento WHERE (Sis_HV_Novedad.Estado = 4) AND (Sis_HV_Novedad.Id_Sol = @User ) ORDER BY Sis_HV_Novedad.Fech_Sol">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="User" Name="User" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
