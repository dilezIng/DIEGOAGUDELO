...
Public Class Mantenimiento_Actividad
 ...
 Dim num As String
  ...
  '  DataNov.Update()
  '  DataHis.InsertCommand = "INSERT INTO Encuesta(Fecha, Resultado,Tipo_Man, Evento ) VALUES ( ( CONVERT (VARCHAR(10), GETDATE(), 103) + ' ' + CONVERT (VARCHAR(8), GETDATE(), 108) ) ,'0','" & Rsa2(1) & "', '" & num & "') "
  '  DataHis.Insert()
    ...
    'Response.AddHeader("REFRESH", "5;Actividad.aspx")
