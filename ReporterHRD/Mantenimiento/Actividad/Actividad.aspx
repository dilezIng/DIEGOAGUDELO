...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:ListItem Value="1">No</asp:ListItem>
   ...
   </asp:DropDownList>                          <asp:Button ID="Btnguardar" runat="server" BackColor="#7DC5FF" Text="Guardar" UseSubmitBehavior="False" /> </strong></td>
...
<asp:Title Alignment="TopCenter" Font="Microsoft Sans Serif, 12pt" Name="Total Mantenimientos" Text="Total Mantenimientos"></asp:Title>
 ...
 SortExpression="Prioridad" ReadOnly="True" />
       ...
       ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" 
             SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso' END AS Estado, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) &gt; Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1 OR Sis_HV_Novedad.Estado = 3) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY Sis_HV_Novedad.Fech_Sol">
               <SelectParameters>
 ...
 SortExpression="Prioridad" ReadOnly="True" />
       ...
       ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" 
       SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso' END AS Estado, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) &lt;= Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1) AND (Sis_HV_Novedad.Id_Job = @User0) AND (convert(datetime,(CONVERT (VARCHAR(10), Sis_HV_Novedad.Fech_Sol, 101) + ' ' + CONVERT (VARCHAR(8),Sis_HV_Novedad.Fech_Sol, 108)),102) < GETDATE()) ORDER BY FechaEntrega">
 <SelectParameters>
 ...
 <td class="style1">
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso' END AS Estado, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) &lt;= Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 3) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY FechaEntrega">
 <SelectParameters>
       ...
       Terminados
                   ...
                   <ContentTemplate>                           <asp:Panel ID="oo" runat="server">
                         <Table tyle="width: 100%"><tr><td class="style8" style="text-align: center; background-image: url('../../Images/Fondo02.jpg'); color: #FFFFFF; font-weight: bold; font-size: 25px;"><asp:Button ID="BtnExportar" runat="server" Text="Exportar" /> Mantenimientos por Aprobar <asp:Label ID="LabelEstadoForm3" runat="server"></asp:Label>
               </td>
                  <tr><td>
