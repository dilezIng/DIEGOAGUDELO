...
<body  bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0" style="text-align: center">
    ...
    <div>
        ...
        SelectCommand="SELECT [RoleName] FROM [vw_aspnet_Roles] where RoleName='user'">
        </asp:SqlDataSource>
                    ...
                    <ContentTemplate>
                        <table border="0" style="width: 364px">
                            ...
                            <tr>
                                ...
                                <td style="width: 207px; text-align: left">
                                    <asp:TextBox ID="Question" runat="server" ReadOnly="True">Color Favorito</asp:TextBox>
        ...
        <br />
        <hr />
        <span style="font-size: 8pt; font-family: Arial">2019 Hrd</span>
    </form>
</body>
</html>
