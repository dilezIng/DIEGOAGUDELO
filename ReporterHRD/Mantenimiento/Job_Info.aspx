<%@ Page Title="Solicitud Mantenimiento PC" Language="VB" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Job_Info.aspx.vb" Inherits="PaginaBase" %>
    ...
    <tr>
        ...
        <td colspan="5"
            style="text-align: center; background-image: url('../Images/Fondo01.jpg'); color: #FFFFFF; font-weight: bold; font-size: 20px;" 
                            class="style8">
                            REQUERIMIENTOS DE INFORMACION<asp:Label ID="LabelEstadoFom" runat="server"></asp:Label>
                            </td>
    </tr>
    <tr>
...
<asp:Label ID="Label1" runat="server" Text="Tema: "></asp:Label>
            ...
            <asp:DropDownList ID="Codigo" runat="server" AutoPostBack="True" 
                ...
                <asp:ListItem>Capacitación</asp:ListItem>
				 <asp:ListItem>Dinamica</asp:ListItem>
                <asp:ListItem>Facturación</asp:ListItem>
                <asp:ListItem>Informes</asp:ListItem>
                <asp:ListItem>Medilab</asp:ListItem>
                <asp:ListItem>Normatividad</asp:ListItem>
<asp:ListItem>Videoconferencias</asp:ListItem>
    ...
    <tr>
        <td colspan="5" valign="middle">
            ...
            <br>&nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server"></asp:SqlDataSource>
            <br>
            <br></br>
            <br></br>
            </br>
