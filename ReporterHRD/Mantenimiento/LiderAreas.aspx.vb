...
Public Class Mantenimiento_Actividad
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load, TextBox1.Load, DataTime.Load, TextBoxev.load
        ...
        If Rsa2.Read() Then
            ...
            DataHis.InsertCommand = "INSERT INTO Encuesta(Fecha, Resultado,Tipo_Man, Evento ) VALUES ('" & Hora & "','5','" & Rsa2(2) & "', '" & num & "') "
            DataHis.Insert()
    ...
    Protected Sub Btnguardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnguardar.Click
        ...
        Else
            ...
            correo.Body = "Buen día " & vbNewLine & " " & vbNewLine & "" & vbNewLine & "" & reali & "" & vbNewLine & " " & vbNewLine & "" & vbNewLine & "Contesto a su colicitud :  " & Act & " " & vbNewLine & " " & vbNewLine & "" & vbNewLine & " ------- Oficina de Sistemas HRD  ------"
    ...
    Protected Sub GridEvento_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridEvento.SelectedIndexChanged
        ...
        ' Response.Redirect("/Sistemas/Bitacora_PMP/PaginaBase.aspx")   Select Realiza FROM Sis_HV_NOVHIST WHERE Evento = res And Id=r
