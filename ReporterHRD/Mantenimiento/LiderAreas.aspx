<%@ Page Title="Actividad" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.master" CodeFile="LiderAreas.aspx.vb" Inherits="Mantenimiento_Actividad" %>
...
<asp:ControlParameter ControlID="User0" Name="User0" />
 ...
 <tr>
 <td    style="text-align: center; color: #FFFFFF; font-weight: bold; font-size: 25px;" class="style2">Mantenimientos Solicitados excedidos de tiempo&#160;
...
<asp:BoundField DataField="FechaEntrega" HeaderText="FechaEntrega" SortExpression="FechaEntrega" ReadOnly="True" />
        ...
        SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso' END AS Estado, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) &gt; Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1 OR Sis_HV_Novedad.Estado = 3) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY Sis_HV_Novedad.Fech_Sol">
...
<asp:ControlParameter ControlID="User0" Name="User0" />
 ...
 <tr>
 <td   style="text-align: center; background-image: url('../../Images/Fondo04.jpg'); color: #FFFFFF; font-weight: bold; font-size: 25px;" class="style8">Mantenimientos solicitados
...
<br />
 ...
 <tr>
 <td  class="style8" style="text-align: center; color: #FFFFFF; font-weight: bold; font-size: 25px; background-image:url('../../Images/Fondo03.jpg')" >Mantenimientos Reabiertos
...
<SelectParameters>
            ...
            <asp:GridView ID="pendiente0" runat="server" DataKeyNames="Evento" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="DataListeventp0" EmptyDataText="No hay Eventos Pendientes.">
...
<asp:Panel ID="History" runat="server" Width="1400" ScrollBars="Both">
        ...
        <div class="auto-style3">
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" AlternatingRowStyle-BackColor="#cccccc" EmptyDataText="Sin Datos" Font-Names="Tahoma" ShowHeaderWhenEmpty="True">
                ...
                <Columns>
                    ...
                    <asp:ImageField DataAlternateTextFormatString="~/Images/Inf.png" DataImageUrlFormatString="~/Images/Inf.png">
                    </asp:ImageField>
            ...
            <asp:Label ID="Label2" runat="server" BackColor="LightSeaGreen" Font-Size="Large" Visible="false"></asp:Label>
