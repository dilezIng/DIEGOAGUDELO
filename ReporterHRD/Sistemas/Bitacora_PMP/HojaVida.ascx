...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="HojaVida.ascx.vb" Inherits="Sistemas_Bitacora_PMP_HojaVida" %>
                    ...
                    <asp:Panel ID="PanelBusqPorComponente" runat="server" BackColor="White" Width="100%">
                        <table style="width: 700px">
                           ...
                           <asp:Panel ID="PanelMsg" runat="server" BackColor="White" BorderColor="#999999" 
                               BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Center" Width="2000px">
                           ...
                           <br />
                    <asp:Panel  ID="PanelHistory" runat="server" BorderColor="#CCCCCC"  BorderStyle="Solid" BorderWidth="1px" CssClass="modalPopup" Height="400px" Width="150%" ScrollBars="Both" >
                        
                                               <strong>Serial:</strong>
                        <asp:Label ID="lbresial" runat="server"></asp:Label>
                        &nbsp;&nbsp;<strong>Sitio:</strong><asp:Label ID="Sitio" runat="server"></asp:Label>
                        &nbsp; <strong>Nombre Equipo:</strong>
                        <asp:Label ID="Nombre" runat="server"></asp:Label>
                        <br>
                                               <table class="auto-style5">
                                                   <tr>
                                                       <td class="auto-style2" style="text-align: center; background-image: url('../../Images/Fondo01.jpg');">Historial Mantenimiento</td>
                                                   </tr>
                                                   <tr>
                                                       <td class="auto-style2">
                                                           <asp:GridView ID="GridEventos" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="auto-style4" DataSourceID="DataGridView" EmptyDataText="NO HAY INFORMACION PARA LA SELECCION" PageSize="300" Width="150%">
                                                               <AlternatingRowStyle BackColor="#F0F0F0" />
                                                               <Columns>
                                                                   ...
                                                                   <asp:BoundField DataField="Solicitud" HeaderStyle-Width="20px" HeaderText="Solicitud" ItemStyle-Width="30%" SortExpression="Solicitud">
                                                                   <HeaderStyle Width="20px" />
                                                                   <ItemStyle Width="30%" />
                                                                   </asp:BoundField>
                                                                   <asp:BoundField DataField="Responsable" HeaderStyle-Width="3%" HeaderText="Responsable" ItemStyle-Width="2%" SortExpression="Responsable">
                                                                   <HeaderStyle Width="3%" />
                                                                   <ItemStyle Width="2%" />
                                                                   </asp:BoundField>
                                                                   <asp:BoundField DataField="Trabajo_Realizado" HeaderStyle-Width="30%" HeaderText="Trabajo_Realizado" SortExpression="Trabajo_Realizado">
                                                                   <HeaderStyle Width="30%" />
                                                                   </asp:BoundField>
                                                                   <asp:BoundField DataField="Estado" HeaderStyle-Width="3%" HeaderText="Estado" ReadOnly="True" SortExpression="Estado">
                                                                   <HeaderStyle Width="3%" />
                                                                   </asp:BoundField>
                                                                   <asp:BoundField DataField="Tipo_Mantenimiento" HeaderStyle-Width="5%" HeaderText="Tipo_Mantenimiento" ReadOnly="True" SortExpression="Tipo_Mantenimiento">
                                                                   <HeaderStyle Width="5%" />
                                                                   </asp:BoundField>
                                                           ...
                                                           <asp:SqlDataSource ID="DataGridView" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" SelectCommand="SELECT Sis_HV_Historial.Id_Evento AS Evento, Sis_HV_Novedad.Id_Sol AS Solicito, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Id_Job AS Responsable, Sis_HV_Historial.Actividad AS Trabajo_Realizado, CASE WHEN Sis_HV_Historial.Estado = 4 THEN 'Aprobado' ELSE 'Pendiente' END AS Estado, (SELECT Tipo_Man FROM Sis_HV_TiposMantenimiento WHERE (Id = Sis_HV_Historial.Tipo_Man)) AS Tipo_Mantenimiento, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, CONVERT (datetime, Sis_HV_Historial.Fech_En, 103)) / 60 / 24 AS Días, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, CONVERT (datetime, Sis_HV_Historial.Fech_En, 103)) / 60 % 24 AS Horas, (SELECT TOP (1) CASE WHEN Archivo IS NULL THEN ' ' ELSE '~/Mantenimiento/Documentos/' + Archivo END AS Expr1 FROM Sis_HV_NOVHIST WHERE (Evento = Sis_HV_Historial.Id_Evento) AND (Realiza IS NOT NULL) ORDER BY Id DESC) AS Adjuntos FROM Sis_HV_Historial INNER JOIN Sis_HV_Equipos ON Sis_HV_Historial.Id_Equipo = Sis_HV_Equipos.Serial INNER JOIN Sis_HV_Novedad ON Sis_HV_Historial.Id_Evento = Sis_HV_Novedad.Id_Evento WHERE (Sis_HV_Equipos.IdEquipo = @LabelIdEquipo) ORDER BY Sis_HV_Novedad.Fech_Sol">
                                                               <SelectParameters>
                                               ...
                                               <asp:SqlDataSource ID="DataConsultas" runat="server" ConnectionString="<%$ ConnectionStrings:DbBridgeConnectionString %>" InsertCommand="INSERT INTO Sis_HV_Equipos(CodigoEquipo, FechaCompra, Serial, Descripcion) VALUES (N'abc', CONVERT (DATETIME, '2003-01-02 00:00:00', 102), N'abc123', N'abc123')"></asp:SqlDataSource>
