...
Partial Class Sistemas_Bitacora_PMP_HojaVida
    ...
    Protected Sub BtnInsertarComponente_Click(sender As Object, e As System.EventArgs) Handles BtnInsertarComponente.Click
        ...
        Else
            ...
            Else
                ...
                IDD = "Com_" & ID
                DataNov0.UpdateCommand = "INSERT Sis_Hv_Audubica( Id_ubicaciones,Usuario,Dates) VALUES ('" & IDD & "','" & useer & "',GETDATE() )"
                DataNov0.Update()
    ...
    Protected Sub BtnMantenimeintos_Click(sender As Object, e As System.EventArgs) Handles BtnMantenimeintos.Click
        ...
        PanelHistory.Visible = True
        lbresial.text = TextBoxSerial.Text
        Sitio.text = LabelUbicacion.Text


        Dim serial As String = TextBoxSerial.Text
        Dim SQLa As String
        Dim nom As String
        ...
        SQLa = "SELECT  top 1  CASE WHEN NomEquipo  IS NOT NULL THEN NomEquipo ELSE 'SIN MANTENIMIENTOS' END  FROM Sis_HV_Historial WHERE Id_Equipo=N'" & serial & "'  "

        '' SQLa = " Select Ca TOP(1) Sis_HV_UbicacionesEquipos.NombreEquipo FROM Sis_HV_UbicacionesEquipos INNER JOIN Sis_HV_Equipos On Sis_HV_UbicacionesEquipos.IdEquipo = Sis_HV_Equipos.IdEquipo WHERE (Sis_HV_Equipos.Serial =N'" & serial & "') ORDER BY Sis_HV_Equipos.Serial DESC "
        Coma = New SqlCommand(SQLa, timedatea)
        Rsa = Coma.ExecuteReader()
        ...
        If Rsa.Read() Then
            ...
            If String.IsNullOrEmpty(Rsa(0)) Then
            Else nom = Rsa(0)
            End If
