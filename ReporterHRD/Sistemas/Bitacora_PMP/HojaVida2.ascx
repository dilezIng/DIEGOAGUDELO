 ...
 <table style="width: 100%; font-family: tahoma; font-size: 10pt;">
                ...
                <asp:Panel ID="PanelModal" runat="server">
                    ...
                    <asp:Panel ID="PanelBusqPorComponente" runat="server" BackColor="White" Width="100%">
                        <table style="width: 700px">
                           ...
                           <br />
                    <asp:Panel  ID="PanelHistory" runat="server" BorderColor="#CCCCCC"  BorderStyle="Solid" BorderWidth="1px" CssClass="modalPopup"  Width="100%" ScrollBars="Both" >
    ...
    <table style="width: 563px">
                                    <tr>
                                            ...
                                            <td style="text-align: center; background-image: url('../../Images/Fondo01.jpg');" class="auto-style2">Historial Mantenimiento<br /> </td></tr>
                                            <tr> <td class="auto-style2">
                                                <asp:GridView ID="GridEventos" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="DataGridView" EmptyDataText="NO HAY INFORMACION" PageSize="300" Width="100%" Enabled="TRUE" Visible="False" CssClass="auto-style4">
                                                    <AlternatingRowStyle BackColor="#F0F0F0" />
                                                    <Columns>
                                                      
                                                        <asp:BoundField DataField="Evento" HeaderText="Evento" ItemStyle-Width="5%" SortExpression="Evento"></asp:BoundField>
