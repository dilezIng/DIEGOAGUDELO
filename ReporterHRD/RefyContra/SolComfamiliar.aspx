...
<%@ Page Title="Solicitud Procedimiento Comfamiliar" Language="VB" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="false" CodeFile="SolComfamiliar.aspx.vb" Inherits="PaginaBase" %>
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server" 
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <tr style="font-weight: bold; font-size: 20pt; color: #FFFFFF; background-image: url('../Images/Fondo01.jpg');">
            <td colspan="4">Solicitud Procedimientos Comfamiliar + 321.860 </td>
