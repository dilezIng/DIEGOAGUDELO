<%@ Page Title="Solicitud Mantenimiento" Language="VB" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Job_Infra.aspx.vb" Inherits="PaginaBase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <script language="javascript">
   ...
   <style type="text/css">
    ...
    <asp:Panel ID="panelSolicitud" runat="server" Height="600px" Width="1000px" >
    ...
    <tr>
        ...
        <td colspan="5"
            style="text-align: center; background-image: url('../Images/Fondo01.jpg'); color: #FFFFFF; font-weight: bold; font-size: 20px;" 
                            class="style8">
                            REQUERIMIENTOS DE INFRAESTRUCTURA <asp:Label ID="LabelEstadoFom" runat="server"></asp:Label>
                            </td>
    </tr>
    <tr>
...
<asp:Label ID="Label1" runat="server" Text="Tema: "></asp:Label>
    ...
    <tr>
        <td colspan="5" valign="middle">
            ...
            <br>&nbsp;<asp:Button ID="Btnguardar" runat="server" Text="Guardar" UseSubmitBehavior="false" />
            <br>
    ...
    <tr>
        ...
        <td>
            ...
            &nbsp;</td>
              ...
              <asp:Panel ID="Paneluser" runat="server" Height="450px" Width="864px">
