<%@ Page Title="Solicitud Mantenimiento" Language="VB" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Job.aspx.vb" Inherits="PaginaBase" %>
   ...
   <style type="text/css">
    ...
    <tr>
        ...
        <td class="auto-style5" >
            ...
            <asp:SqlDataSource ID="SqlDataArea" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT NombreDependecia FROM Sis_HV_Dependencias WHERE (NombreDependecia NOT LIKE N'%BODEGA%') OR (NombreDependecia NOT LIKE N'%_%') ORDER BY NombreDependecia"></asp:SqlDataSource>
        ...
        <td class="style15">
            ...
            <asp:DropDownList ID="Codigo" runat="server" AutoPostBack="True" CssClass="auto-style6">
                <asp:ListItem Value="1">Biomedico</asp:ListItem>
               
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSourcePc1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" 
                
                SelectCommand="SELECT Sis_HV_UbicacionesEquipos.NombreEquipo FROM Sis_HV_UbicacionesEquipos INNER JOIN Sis_HV_Equipos ON Sis_HV_UbicacionesEquipos.IdEquipo = Sis_HV_Equipos.IdEquipo ORDER BY Sis_HV_Equipos.Serial DESC">
            </asp:SqlDataSource>
