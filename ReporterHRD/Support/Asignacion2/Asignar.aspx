...
<asp:Series ChartArea="ChartArea1" ChartType="Pie" Font="Microsoft Sans Serif, 20.25pt, style=Bold" IsValueShownAsLabel="True" IsXValueIndexed="True" Legend="Legend1" Name="Mantenimientos" XValueMember="Estado" YValueMembers="Cantidad">
...
<asp:BoundField DataField="FechaEntrega" HeaderText="FechaEntrega" ReadOnly="True" SortExpression="FechaEntrega"></asp:BoundField>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 2 THEN 'Terminado' WHEN Sis_HV_Novedad.Estado = 1 THEN (CASE WHEN Sis_HV_Historial.Actividad = 'Pendiente' THEN 'En Espera' ELSE 'En Proceso' END) END AS Estado, Sis_HV_Novedad.Id_Job AS Responsable, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) / 24 AS Utilizados, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento WHERE (Sis_HV_Novedad.Estado = 3) ORDER BY Sis_HV_Novedad.Fech_Sol">
                        <SelectParameters>
...
<asp:BoundField DataField="FechaEntrega" HeaderText="FechaEntrega" ReadOnly="True" SortExpression="FechaEntrega"></asp:BoundField>
                    ...
                    <asp:SqlDataSource ID="DataListevent2" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 2 THEN 'Terminado' WHEN Sis_HV_Novedad.Estado = 1 THEN (CASE WHEN Sis_HV_Historial.Actividad = 'Pendiente' THEN 'En Espera' ELSE 'En Proceso' END) END AS Estado, Sis_HV_Novedad.Id_Job AS Responsable, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, GETDATE()) &lt;= Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1) ORDER BY Sis_HV_Novedad.Fech_Sol">
                        <SelectParameters>
<asp:ControlParameter ControlID="TextBoxev" Name="TextBoxev" PropertyName="Text" />
</SelectParameters>
</asp:SqlDataSource>
...
<td class="auto-style8" style="text-align: center; background-image: url('../../Images/Fondo02.jpg'); color: #FFFFFF; font-weight: bold; font-size: 25px;" >
    ...
    <tr>
        ...
        <td class="auto-style10">
         ...
         <asp:BoundField DataField="Dias" HeaderText="Dias" ReadOnly="True" SortExpression="Dias" > </asp:BoundField>
                <asp:BoundField DataField="Horas" HeaderText="Horas" ReadOnly="True" SortExpression="Horas" >  </asp:BoundField>
    ...
    <table id="TabAsigna" align="left" border="1" width="90%">
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="Id_Job" runat="server" DataSourceID="SqlDataId_Job" DataTextField="USUDESCRI" DataValueField="USUNOMBRE">
                </asp:DropDownList>
            </td>
        ...
        <tr>
            <td colspan="6">
                ...
                <asp:SqlDataSource ID="SqlDataId_Job" runat="server" ConnectionString="<%$ ConnectionStrings:DGEMPRES02ConnectionString %>" SelectCommand="SELECT USUNOMBRE, USUDESCRI FROM GENUSUARIO WHERE (USUNOMBRE LIKE 'MAN%' OR USUNOMBRE LIKE 'AMA%') AND (USUESTADO &lt;&gt; 4) ORDER BY USUNOMBRE"></asp:SqlDataSource>
