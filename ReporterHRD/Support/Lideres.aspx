<%@ Page Title="" Language="VB" MasterPageFile="~/PaginaMaestra.master" AutoEventWireup="false" CodeFile="Lideres.aspx.vb" Inherits="Mantenimiento_Lideres" %>
...
<td style="background-image: url('../../Images/Fondo01.jpg'); color: #FFFFFF; font-weight: bold; font-size: 20px;" 
        class="auto-style23" bgcolor="#79C2FC"> <span class="auto-style28">Lider de Area <asp:TextBox ID="User" runat="server" Visible="true" BackColor="#70BDFA" BorderStyle="None" Font-Bold="True" Font-Italic="True" Font-Names="Tahoma" Font-Size="Large" ForeColor="White" ReadOnly="True" Width="400px"></asp:TextBox>
...
<td class="style1">
                                ...
                                <asp:SqlDataSource ID="DataListevent" runat="server" 
                                    ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" 
                       SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Nota AS Solicitud, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' ELSE (CASE WHEN Sis_HV_Novedad.Estado = 2 THEN 'Terminado' ELSE 'En Espera' END) END AS Estado, DATEDIFF(day, Sis_HV_Novedad.Fech_Sol, @TextBoxev) AS Dias, CASE WHEN Sis_HV_Novedad.Id_Job = 'AMA001' THEN 'Alexander Puerto' WHEN Sis_HV_Novedad.Id_Job = 'AMA004' THEN 'Brayan León' WHEN Sis_HV_Novedad.Id_Job = 'AMA003' THEN 'Sergio Baez' WHEN Sis_HV_Novedad.Id_Job = 'MAN003' THEN 'Jefferson Niño' WHEN Sis_HV_Novedad.Id_Job = 'MAN004' THEN 'Edna Cuta' ELSE 'Por asignar' END AS Responsable, Sis_HV_Historial.Actividad AS Trabajo_Realizado FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento WHERE (Sis_HV_Novedad.Estado &lt; 4) AND (DATEDIFF(day, Sis_HV_Novedad.Fech_Sol, @TextBoxev) &gt; 4) AND (Sis_HV_Novedad.Id_Sol = @User ) ORDER BY Dias DESC">
                                    <SelectParameters>
...
<asp:GridView ID="GridEvento2" runat="server" AutoGenerateColumns="False"  
        ...
        SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Fech_Sol AS Fecha_sol, Sis_HV_Novedad.Nota AS Solicitud, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 2 THEN 'Terminado' WHEN Sis_HV_Novedad.Estado = 1 THEN (CASE WHEN Sis_HV_Historial.Actividad = 'Pendiente' THEN 'En Espera' ELSE 'En Proceso' END) END AS Estado, DATEDIFF(day, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) AS Dias, CASE WHEN Sis_HV_Novedad.Id_Job = 'AMA001' THEN 'Alexander Puerto' WHEN Sis_HV_Novedad.Id_Job = 'AMA004' THEN 'Brayan León' WHEN Sis_HV_Novedad.Id_Job = 'AMA003' THEN 'Sergio Baez' WHEN Sis_HV_Novedad.Id_Job = 'MAN003' THEN 'Jefferson Niño' WHEN Sis_HV_Novedad.Id_Job = 'MAN004' THEN 'Edna Cuta' ELSE 'Por asignar' END AS Responsable, Sis_HV_Historial.Actividad AS Trabajo_Realizado FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento INNER JOIN Sis_HV_Dependencias ON Sis_HV_Historial.Area = Sis_HV_Dependencias.NombreDependecia WHERE (Sis_HV_Novedad.Estado % 2 &gt; 0) AND (Sis_HV_Dependencias.Lider = @User ) OR (Sis_HV_Novedad.Estado % 2 &gt; 0) AND (Sis_HV_Dependencias.Colaborador = @User ) ORDER BY Estado DESC">
                                    <SelectParameters>
                                       
                                       <asp:ControlParameter ControlID="User0" Name="User" PropertyName="Text" />
...
<td class="style1">
    ...
    <tr>
        <td class="style1">
            ...
            <asp:SqlDataSource ID="DataListeventp0" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT DISTINCT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS TemaEquipo, Sis_HV_Novedad.Fech_Sol, Sis_HV_Novedad.Nota AS Novedad, CASE WHEN Sis_HV_Novedad.Id_Job = 'AMA001' THEN 'Alexander Puerto' WHEN Sis_HV_Novedad.Id_Job = 'AMA004' THEN 'Brayan León' WHEN Sis_HV_Novedad.Id_Job = 'AMA003' THEN 'Sergio Baez' WHEN Sis_HV_Novedad.Id_Job = 'MAN003' THEN 'Jefferson Niño' WHEN Sis_HV_Novedad.Id_Job = 'MAN004' THEN 'Edna Cuta'  ELSE 'Por asignar' END AS Realizo, Sis_HV_Historial.Actividad AS Trabajo_Realizado, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) / 60 / 24 AS Días, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) / 60 % 24 AS Horas, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) % 60 AS Min, Sis_HV_Novedad.Estado, Sis_HV_Novedad.Id_Sol, Sis_HV_Dependencias.Lider FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento INNER JOIN Sis_HV_Dependencias ON Sis_HV_Historial.Area = Sis_HV_Dependencias.NombreDependecia WHERE (Sis_HV_Novedad.Estado = 2) AND (Sis_HV_Dependencias.Lider = @User0 or Sis_HV_Dependencias.Colaborador = @User0) ORDER BY Sis_HV_Novedad.Fech_Sol">
                <SelectParameters>
...
<asp:GridView ID="pendiente" runat="server" AutoGenerateColumns="False"  DataKeyNames="Evento" DataSourceID="DataListeventp" EmptyDataText="No hay Eventos Pendientes." AllowSorting="True">
        ...
        SelectCommand="SELECT DISTINCT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Fech_Sol, Sis_HV_Novedad.Nota AS Novedad, CASE WHEN Sis_HV_Novedad.Id_Job =  'AMA001' THEN 'Alexander Puerto' WHEN Sis_HV_Novedad.Id_Job = 'AMA004' THEN 'Brayan León' WHEN Sis_HV_Novedad.Id_Job = 'AMA003' THEN 'Sergio Baez' WHEN Sis_HV_Novedad.Id_Job = 'MAN003' THEN 'Jefferson Niño' WHEN Sis_HV_Novedad.Id_Job = 'MAN004' THEN 'Edna Cuta' ELSE 'Por asignar' END AS Realizo, Sis_HV_Historial.Actividad AS Trabajo_Realizado, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) / 60 / 24 AS Días, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) / 60 % 24 AS Horas, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, Sis_HV_Historial.Fech_En) % 60 AS Min, Encuesta.Resultado AS SATISFACION, Sis_HV_Dependencias.Lider FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento INNER JOIN Encuesta ON Sis_HV_Historial.Id_Evento = Encuesta.Evento INNER JOIN Sis_HV_Dependencias ON Sis_HV_Historial.Area = Sis_HV_Dependencias.NombreDependecia WHERE (Sis_HV_Novedad.Estado = 4) AND (Sis_HV_Dependencias.Lider = @User0 or Sis_HV_Dependencias.Colaborador = @User0) ORDER BY Sis_HV_Novedad.Fech_Sol">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="User0" Name="User0" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
