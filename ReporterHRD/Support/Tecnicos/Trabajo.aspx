<%@ Page Title="Actividad" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.master" CodeFile="Trabajo.aspx.vb" Inherits="Mantenimiento_Trabajo" %>
...
</td></tr><tr><td style="text-align: left;" class="style6"><asp:Label ID="Label1" runat="server" Text="Solicitud: "></asp:Label>
...
<asp:TextBox ID="Codigo" runat="server" ReadOnly="True" BorderColor="White" BorderStyle="None" ForeColor="White"></asp:TextBox>
                                          ...
                                          <asp:Label ID="notavalida" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                          ...
                                          </td><td class="auto-style1"><table class="auto-style4"><tr><td class="auto-style5"></td><td></td><td class="auto-style11">
                                              ...
                                              </td><td></td></tr><tr><td class="auto-style6"><strong>
                                              ...
                                              <asp:Label ID="Label14" runat="server" CssClass="auto-style8" Text="Cerrar solicitud "></asp:Label>
                                              ...
                                              <td class="auto-style10"><strong>
                                                  ...
                                                  <asp:DropDownList ID="ListEstado" runat="server" CssClass="auto-style9"><asp:ListItem Value="1">No</asp:ListItem>
...
<asp:ListItem Value="2">Si</asp:ListItem>
                                                  ...
                                                  <asp:Button ID="Btnguardar" runat="server" BackColor="#7DC5FF" Text="Guardar" UseSubmitBehavior="False" />
                                              ...
                                              <td class="auto-style12"></td><td class="auto-style10"></td></tr><tr><td class="auto-style5"></td><td>
                                              ...
                                              </td><td class="auto-style11"></td><td></td></tr></table></td><td class="style7"></td></tr><tr><td colspan="3" class="auto-style2">
                                      ...
                                      <asp:Label ID="Label13" runat="server" Text="Mantenimiento:  "></asp:Label>
                                      ...
                                      </td></tr><tr><td class="style4" style="text-align: LEFT;" colspan="3"><asp:TextBox ID="Nota" TextMode="MultiLine" runat="server" Height="100px" Width="1000px" ValidationGroup="true"></asp:TextBox>
...
</td></tr><tr><td class="style4" colspan="3" style="text-align: LEFT;"><strong>Adjuntar Archivos: </strong><asp:FileUpload ID="FileUpload" runat="server" Width="234px" />
...
&#160;</td></tr><tr><td colspan="3"></td></tr><tr><td class="style10"><br /><asp:TextBox ID="TextBox1" runat="server" BorderColor="White" 
...
</td><td class="style9" colspan="2"><asp:LoginStatus ID="LoginStatus1" runat="server" LogoutPageUrl="~/Fosyga.aspx" style="font-family: Tahoma; font-size: 8pt; color:White " />
...
<asp:SqlDataSource ID="DataConsultas" runat="server" 
                ...
                ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>"></asp:SqlDataSource>
...
<asp:SqlDataSource ID="Dataevent" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>"></asp:SqlDataSource>
...
<asp:panel  ID="Panel_evento" runat="server"><Table tyle="width: 100%"><tr ><td><div class="auto-style3"><asp:Chart ID="Chart1" runat="server" DataMember="DefaultView" DataSourceID="SqlDataSource3" EnableViewState="True" SuppressExceptions="True" ViewStateContent="Default, Appearance" Width="426px" IsMapAreaAttributesEncoded="True"><series>
...
<axisx textorientation="Stacked"></axisx>

<Area3DStyle Enable3D="True" Inclination="20" Rotation="20" ></area3dstyle>
</asp:ChartArea>
</chartareas>
<legends>
...
</td></tr><tr><td style="text-align:left; background-image: url('../../Images/Fondo01.jpg'); color: #FFFFFF; font-weight: bold; font-size: 12px;" class="style8"><asp:TextBox ID="TextBoxev" runat="server" BorderColor="#7AC2FC" 
...
</td></tr><tr><td    style="text-align: center; color: #FFFFFF; font-weight: bold; font-size: 25px;" class="style2">Mantenimientos Solicitados excedidos de tiempo&#160; <asp:Label ID="LabelEstadoForm4" runat="server"></asp:Label>
...
</td></tr><tr><td></asp:Table><asp:GridView ID="GridEvento" runat="server" AutoGenerateColumns="False" class="style2" DataKeyNames="Evento"
                DataSourceID="DataListevent" EmptyDataText="No hay Eventos Excedidos de tiempo." AllowSorting="True" Width="1266px" ><Columns>
...
<asp:BoundField DataField="FechaEntrega" HeaderText="FechaEntrega" SortExpression="FechaEntrega" ReadOnly="True" />
        ...
        SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso' END AS Estado, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) &gt; Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY Sis_HV_Novedad.Fech_Sol">
                                    <SelectParameters>
...
<asp:ControlParameter ControlID="User0" Name="User0" />
...
</td></tr><tr><td   style="text-align: center; background-image: url('../../Images/Fondo04.jpg'); color: #FFFFFF; font-weight: bold; font-size: 25px;" class="style8">Mantenimientos solicitados <asp:Label ID="LabelEstadoForm1" runat="server"></asp:Label>
                ...
                DataSourceID="DataListevent2" EmptyDataText="No hay Eventos Pendientes." AllowSorting="True"
                                              BackColor="#F0F0F0" Width="1257px" ><Columns>
...
<asp:BoundField DataField="FechaEntrega" HeaderText="FechaEntrega" SortExpression="FechaEntrega" ReadOnly="True" />
        ...
        SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso' END AS Estado, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) &lt;= Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY FechaEntrega"><SelectParameters>
...
</td></tr><tr><td><asp:TextBox ID="User0" runat="server" Visible="False"></asp:TextBox>
...
</td></tr><tr><td><asp:Label ID="LabelMsg" runat="server" BackColor="LightSeaGreen" Font-Size="Large"></asp:Label>
...
<br /><asp:Label ID="LabelError" runat="server" ></asp:Label>
...
</td></tr><tr><td  class="style8" style="text-align: center; color: #FFFFFF; font-weight: bold; font-size: 25px; background-image:url('../../Images/Fondo03.jpg')" >Mantenimientos Reabiertos <asp:Label ID="Label3" runat="server"></asp:Label>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Historial.Area, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso' END AS Estado, Sis_HV_Historial.Prioridad / 24 AS Prioridad, DATEDIFF(hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) / 24 AS Utilizadas, DATEADD(hour, Sis_HV_Historial.Prioridad, Sis_HV_Novedad.Fech_Sol) AS FechaEntrega FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) &lt;= Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 3) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY FechaEntrega"><SelectParameters>
...
<ContentTemplate>
    ...
    <Table tyle="width: 100%"><tr><td class="style8" style="text-align: center; background-image: url('../../Images/Fondo02.jpg'); color: #FFFFFF; font-weight: bold; font-size: 25px;">Mantenimientos Por Aprobar <asp:Label ID="LabelEstadoForm3" runat="server"></asp:Label></td>
        ...
        <asp:GridView ID="pendiente" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Evento"
            DataSourceID="DataListeventp" EmptyDataText="No hay Eventos Pendientes por aprobar.">
...
<ItemStyle HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="Tiempo_Usado" HeaderText="Tiempo_Usado" ReadOnly="True" SortExpression="Tiempo_Usado" >
<ItemStyle HorizontalAlign="Center" />
</asp:BoundField>
...
<SelectParameters>
            ...
            <br />
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="DataListeventp0" DataKeyNames="Evento">
                 <AlternatingRowStyle BackColor="#F1F1F1" />
                <Columns>
                    <asp:CommandField SelectText="Ver" ShowSelectButton="True" />
                    <asp:BoundField DataField="Solicita" HeaderText="Solicita" SortExpression="Solicita" />
...
<asp:Panel ID="History" runat="server" Width="1400">
    <asp:SqlDataSource ID="History0" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT Date AS Fecha, CASE WHEN Solicita IS NULL THEN ' ' ELSE Solicita END AS Solicito, CASE WHEN NotaSolicita IS NULL THEN ' ' ELSE NotaSolicita END AS Nota, CASE WHEN Solicita IS NOT NULL THEN CASE WHEN Archivo IS NULL THEN ' ' ELSE '~/Support/Documentos/' + Archivo END ELSE '' END AS Adjuntos, CASE WHEN Realiza IS NULL THEN ' ' ELSE Realiza END AS Responsable, CASE WHEN NotaRealiza IS NULL THEN ' ' ELSE NotaRealiza END AS Actividad, CASE WHEN Realiza IS NOT NULL THEN CASE WHEN Archivo IS NULL THEN ' ' ELSE '~/Support/Documentos/' + Archivo END ELSE '' END AS Adjuntos FROM Sis_HV_NOVHIST WHERE (Evento = @TextBox2) ORDER BY Fecha">
        ...
        <div class="auto-style3">
            <div class="auto-style10">
                ...
                <asp:TextBox ID="TextBox2" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" Font-Bold="True" Font-Size="Large" ForeColor="Blue" ReadOnly="True" Visible="False" Width="288px"></asp:TextBox>
                <br />
                <br />
            </div>
        ...
        <div class="auto-style3">
            <br />
            <strong>SOLICITUDES ANTERIORES</strong><br />
            <br />
    ...
    <asp:SqlDataSource ID="DataGridView" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT [Id_Evento], [Id_Equipo], [Actividad], [Id_Job], CASE WHEN Estado = 4 THEN 'Aprobado' ELSE 'Pendiente' END AS Estado FROM [Sis_HV_Historial] WHERE ([Id_Equipo] = @Codigo) order by Id_Evento">
        <SelectParameters>
    ...
    <br />
        ...
        <asp:TextBox ID="Codigo2" runat="server" ReadOnly="True" Visible="False"></asp:TextBox>
