...
Partial Class Support_Biomedicos_HojaVida
    ...
    Protected Sub BtnSubirArchivo_Click(sender As Object, e As System.EventArgs) Handles BtnSubirArchivo.Click
        ...
        Dim path As String = Server.MapPath("~/Support/Biomedicos/Fotos/")
        ...
        If FileUpload1.HasFile Then
            ...
            If fileOK Then
                Try
                    ...
                    ImagenCompo.ImageUrl = "~/Support/Biomedicos/Fotos/" + vbNomArchivo
        ...
        If FileUpload2.HasFile Then
            ...
            If fileOK Then
                Try
                    ...
                    FunAgregarUrlFotoEquipo("~/Support/Biomedicos/Fotos/" + vbNomArchivo, LabelIdEquipo.Text)
