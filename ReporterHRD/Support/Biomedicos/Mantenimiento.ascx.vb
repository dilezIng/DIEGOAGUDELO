...
Partial Class Sistemas_Bitacora_PMP_Mantenimiento
    ...
    Protected Sub GridEvento_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridEvento.SelectedIndexChanged
        ...
        Dim SQL As String
        Dim timedate As New SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\DBSUPPORT.mdf;Integrated Security=True;User Instance=True;")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load, TextBox1.Load, DataTime.Load, TextBoxev.load
        ...
        Response.AddHeader("REFRESH", "60;PaginaBase.aspx")
        ...
        timedate.Close()
        Dim SQLa As String
        Dim timedatea As New SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\DBSUPPORT.mdf;Integrated Security=True;User Instance=True;")
