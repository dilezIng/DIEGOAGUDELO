...
<asp:GridView ID="GridEvento" runat="server" AutoGenerateColumns="False" class="style2" DataKeyNames="Evento"
        ...
        SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, DATEDIFF(day, Sis_HV_Novedad.Fech_Sol, @TextBoxev) AS Dias, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, @TextBoxev) / 60 % 24 AS Horas, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, @TextBoxev) % 60 AS Min, Sis_HV_Novedad.Id_Job AS Responsable, Sis_HV_Historial.Area, Sis_HV_Historial.Prioridad AS Prioridad_Horas, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En curso' END AS Estado FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) &gt; Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY Dias DESC">
                                    <SelectParameters>
...
<asp:GridView ID="GridEvento2" runat="server" AutoGenerateColumns="False" DataKeyNames="Evento"
        ...
        SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS Evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Id_Sol AS Solicita, Sis_HV_Novedad.Nota AS Solicitud, DATEDIFF(day, Sis_HV_Novedad.Fech_Sol, @TextBoxev) AS Dias, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, @TextBoxev) / 60 % 24 AS Horas, DATEDIFF(Minute, Sis_HV_Novedad.Fech_Sol, @TextBoxev) % 60 AS Min, Sis_HV_Novedad.Id_Job AS Responsable, Sis_HV_Historial.Area, Sis_HV_Historial.Prioridad, CASE WHEN Sis_HV_Novedad.Estado = 3 THEN 'Reabierto' WHEN Sis_HV_Novedad.Estado = 1 THEN 'En Proceso'  END AS Estado FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento AND DATEDIFF(Hour, Sis_HV_Novedad.Fech_Sol, @TextBoxev) &lt;= Sis_HV_Historial.Prioridad WHERE (Sis_HV_Novedad.Estado = 1) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY Dias DESC">
                                    <SelectParameters>
...
<td  class="style8" style="text-align: center; color: #FFFFFF; font-weight: bold; font-size: 25px; background-image:url('../../Images/Fondo03.jpg')" >
    ...
    <tr>
        <td class="style1">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBSUPPORTConnectionString %>" SelectCommand="SELECT Sis_HV_Novedad.Id_Evento AS evento, Sis_HV_Historial.NomEquipo AS Equipo, Sis_HV_Novedad.Fech_Sol AS fecha_Solicitud, Sis_HV_Novedad.Nota AS Solicitud, Sis_HV_Novedad.Id_Sol AS Solicita, DATEDIFF(day, Sis_HV_Novedad.Fech_Sol, @TextBoxev) AS Dias, Sis_HV_Novedad.Id_Job AS Responsable, Sis_HV_Historial.Area FROM Sis_HV_Novedad INNER JOIN Sis_HV_Historial ON Sis_HV_Novedad.Id_Evento = Sis_HV_Historial.Id_Evento WHERE (Sis_HV_Novedad.Estado = 3) AND (Sis_HV_Novedad.Id_Job = @User0) ORDER BY Dias DESC">
